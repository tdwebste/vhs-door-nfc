...
#define CONFIG_ESP_CAN_NODE_ITSELF 0x755
#define CONFIG_ESP_CAN_RXD_PIN_NUM 35
#define CONFIG_ESP_CAN_TXD_PIN_NUM 5
// CONFIG_CAN_SPEED_100KBPS is not set
// CONFIG_CAN_SPEED_125KBPS is not set
// CONFIG_CAN_SPEED_250KBPS is not set
// CONFIG_CAN_SPEED_500KBPS is not set
// CONFIG_CAN_SPEED_800KBPS is not set
#define CONFIG_CAN_SPEED_1000KBPS 1
// CONFIG_CAN_SPEED_USER_KBPS is not set
// CONFIG_CAN_TEST_SENDING_ENABLED is not set
#define CONFIG_CAN_TEST_SENDING_DISABLED 1
